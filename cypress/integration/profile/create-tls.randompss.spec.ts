...
describe('Test Profile Page', () => {
  ...
  it('should create a profile with random passwords and TLS config', () => {
    cy.myIntercept('POST', 'profiles', {
      statusCode: apiResponses.profiles.create.success.code,
      body: apiResponses.profiles.create.success.response
    }).as('post-profile2')
    ...
    cy.enterProfileInfo(
      profileFixtures.happyPathTlsRandomPwd.profileName,
      profileFixtures.happyPathTlsRandomPwd.activation,
      true,
      true,
      profileFixtures.happyPathTlsRandomPwd.dhcpEnabled,
      profileFixtures.happyPathTlsRandomPwd.connectionMode,
      profileFixtures.happyPathTlsRandomPwd.tlsConfig
    )
    ...
    cy.wait('@post-profile2').then((req) => {
      ...
      cy.get('mat-cell').contains(profileFixtures.happyPathTlsRandomPwd.profileName)
