...
describe('Test Profile Page', () => {
  ...
  it('should create a profile with random passwords and CIRA profile', () => {
    cy.myIntercept('POST', 'profiles', {
      statusCode: apiResponses.profiles.create.success.code,
      body: apiResponses.profiles.create.success.response
    }).as('post-profile2')
    ...
    cy.enterProfileInfo(
      profileFixtures.happyPathRandomPwd.profileName,
      profileFixtures.happyPathRandomPwd.activation,
      true,
      true,
      profileFixtures.happyPathRandomPwd.dhcpEnabled,
      profileFixtures.happyPathRandomPwd.connectionMode,
      profileFixtures.happyPathRandomPwd.ciraConfig
    )
    ...
    cy.wait('@post-profile2').then((req) => {
      ...
      cy.get('mat-cell').contains(profileFixtures.happyPathRandomPwd.profileName)
